...
public class TeamController {
    ...
    @Operation(summary = "Transfer captain", description = "Transfer team captain role to another user")
    ...
    @Operation(summary = "Get join requests", description = "Get all join requests for current user's team")
