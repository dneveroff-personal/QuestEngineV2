...
public class CodeController {
  ...
  public ResponseEntity<List<CodeResponse>> getCodesByLevel(
    ...
    return ResponseEntity.status(HttpStatus.OK).body(codeService.getCodesByLevelId(levelId));
  }
  ...
  public ResponseEntity<CodeResponse> getCodeById(@PathVariable Long codeId) {
    return ResponseEntity.status(HttpStatus.OK).body(codeService.getCodeById(codeId));
  }
  ...
  public ResponseEntity<CodeResponse> updateCode(
      ...
      @Valid @RequestBody CreateCodeRequest request,
      Authentication auth) {
    return ResponseEntity.status(HttpStatus.OK).body(codeService.updateCode(codeId, request, auth));
  }
