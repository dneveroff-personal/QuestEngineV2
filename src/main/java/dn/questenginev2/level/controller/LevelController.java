...
public class LevelController {
  ...
  public ResponseEntity<List<LevelResponse>> getLevelsByQuest(@PathVariable Long questId) {
    return ResponseEntity.status(HttpStatus.OK).body(levelService.getLevelsByQuestId(questId));
  }
  ...
  public ResponseEntity<LevelResponse> getLevelById(@PathVariable Long levelId) {
    return ResponseEntity.status(HttpStatus.OK).body(levelService.getLevelById(levelId));
  }
